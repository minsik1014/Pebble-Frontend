...
const variantClassNames: Record<ButtonVariant, string> = {
  primary:
    'dark-disabled-primary bg-btn-primary text-text-onFill before:bg-transparent hover:before:bg-[rgba(250,250,250,0.25)] active:before:bg-[rgba(250,250,250,0.4)] dark:hover:before:bg-[rgba(23,23,23,0.05)] dark:active:before:bg-[rgba(23,23,23,0.1)]',
  secondary:
  ...
  cancel:
    'bg-btn-quaternary text-text-strong before:bg-transparent hover:before:bg-[rgba(23,23,23,0.05)] active:before:bg-[rgba(23,23,23,0.1)] dark:text-text-strong dark:hover:before:bg-[rgba(23,23,23,0.15)] dark:active:before:bg-[rgba(23,23,23,0.25)]',
  danger:
