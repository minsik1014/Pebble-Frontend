...
const variantClassNames: Record<ButtonVariant, string> = {
  primary:
    'bg-btn-primary text-text-onFill before:bg-transparent hover:before:bg-[rgba(250,250,250,0.25)] active:before:bg-[rgba(250,250,250,0.4)] dark:hover:before:bg-[rgba(23,23,23,0.05)] dark:active:before:bg-[rgba(23,23,23,0.1)]',
  secondary:
  ...
  cancel:
    'bg-btn-pressed text-text-strong before:bg-transparent hover:before:bg-[rgba(250,250,250,0.18)] active:before:bg-[rgba(250,250,250,0.28)] dark:bg-btn-quaternary dark:text-text-strong',
  danger:
  ...
  return (
    <button
      ...
      className={[
        ...
        'dark:disabled:bg-[rgba(23,23,23,0.7)] dark:disabled:text-text-teritary dark:disabled:opacity-100',
        className,
      ].join(' ')}
      {...props}
    >
