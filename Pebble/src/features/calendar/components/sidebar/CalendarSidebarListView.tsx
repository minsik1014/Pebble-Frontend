            ...
            {group.items.map((datedItem) => {
              ...
              return (
                <div
                  ...
                  className="flex h-12 w-full shrink-0 items-center gap-2 overflow-hidden rounded-token-s bg-fill-inverse py-2 pr-2 shadow-[0px_0px_14px_0px_rgba(23,23,23,0.05)] transition-colors hover:bg-fill-surface"
                >
                  <button
                    type="button"
