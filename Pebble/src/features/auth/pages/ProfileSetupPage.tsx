...
export const ProfileSetupPage = (): JSX.Element => {
  return (
    <main className="w-full h-dvh bg-fill-inverse flex flex-col overflow-hidden [font-family:'Pretendard',sans-serif]" data-id="profile-setup-screen" data-theme="dark">
      <Header />
