...
export const SignUpCompletePage = (): JSX.Element => {
  return (
    <main className="w-full h-dvh bg-fill-inverse flex flex-col overflow-hidden [font-family:'Pretendard',sans-serif]" data-id="signup-complete-screen" data-theme="dark">
      <Header />
