...
export const SignUpCompleteContent = ({
  ...
  return (
    <section
      className="w-full max-w-[570px] p-[32px] flex flex-col items-center gap-[40px] rounded-[20px] bg-white"
    ...
    >
      ...
      <p className="text-center text-[15px] leading-[150%] font-normal tracking-[-0.15px]">
        <span className="text-[#171717]">{nickname}</span>
        <span className="text-[#A3A3A3]">님 가입이 완료되었어요. 오늘의 조약돌을 차곡차곡 쌓아 보세요!</span>
      </p>

      <button
        type="button"
        onClick={onGoToSchedule}
        className="w-full h-[52px] rounded-[12px] bg-[#171717] text-center text-[15px] leading-[150%] font-normal tracking-[-0.15px] text-white hover:bg-[#262626] transition-colors"
      >
        내 일정 기록하러 가기
      </button>
    </section>
