    ...
    <div className="w-full max-w-[440px] flex flex-col px-[16px] sm:px-0 mx-auto mt-[40px] md:mt-[80px]">
      ...
      <form onSubmit={onSubmit} className="flex flex-col w-full">
          ...
          <div className="relative w-full">
            <input
              ...
              className={`w-full h-[48px] sm:h-[52px] pl-[16px] pr-[48px] border rounded-[8px] text-[15px] outline-none transition-all placeholder-[#C5C5C5]
                ${errors.password ? "border-[#FC4C46] focus:border-[#FC4C46]" : "border-[#E5E7EB] focus:border-[#111111]"}`}
            />
            <button
              type="button"
              onClick={onTogglePw}
        ...
        <button
          ...
          className={`w-full h-[48px] sm:h-[52px] text-white rounded-[8px] text-[16px] transition-colors mb-[24px]
