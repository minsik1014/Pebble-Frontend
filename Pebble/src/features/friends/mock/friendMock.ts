...
export const mockFriends: Friend[] = [
  { id: 1, nickname: "기본", email: "default@pebble.com", bio: "", imageUrl: profile2 },
  { id: 2, nickname: "담검이", email: "damgum@pebble.com", bio: "배고프다", imageUrl: profile3 },
  { id: 3, nickname: "돼병", email: "pig병@pebble.com", bio: "여름이 싫어요", imageUrl: profile4 },
  { id: 4, nickname: "산테", email: "sante@pebble.com", bio: "이게 내 전투 방식이다", imageUrl: profile5 },
  { id: 5, nickname: "조료", email: "joro@pebble.com", bio: "아무 일도 없었다", imageUrl: profile1 },
  {
    id: 6,
    nickname: "치이",
...
export const mockUsers: Friend[] = [
  ...mockFriends,
  ...mockFriendRequests.map(({ user }) => user),
  {
    id: 201,
    nickname: "보노보노",
