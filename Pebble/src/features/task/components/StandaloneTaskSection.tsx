    ...
    {tasks.flatMap((task) => {
      ...
      return rows.map((row) => {
        ...
        return (
          <section
            key={`${task.id}-${row.key}`}
            className="flex w-[352px] shrink-0 flex-col overflow-visible rounded-[20px] bg-fill-inverse shadow-[0px_0px_14px_0px_rgba(23,23,23,0.05)] dark:shadow-[0px_0px_8px_0px_rgba(255,255,255,0.06)]"
          >
            <div
