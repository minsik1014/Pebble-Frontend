                    ...
                    {friends.map((friend) => (
                      ...
                      >
                        <button
                          ...
                          className="relative flex size-11 items-center justify-center overflow-hidden rounded-token-s bg-fill-danger text-text-onFill transition-colors dark:bg-fill-danger-bg dark:text-[#242424] before:pointer-events-none before:absolute before:inset-0 before:transition-colors hover:before:bg-[rgba(250,250,250,0.25)] active:before:bg-[rgba(250,250,250,0.4)] dark:hover:before:bg-[rgba(23,23,23,0.7)] dark:active:before:bg-[rgba(23,23,23,0.7)] disabled:opacity-50"
